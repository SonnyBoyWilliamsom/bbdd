...
<header>
    ...
    <div class="update">
        <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
            ...
            <input type="submit" name="update" value="Update Rates" onclick="showComRatesJSON(<?=$field?>,<?=$order?>,'')">
           
        </form>
    </div>   
    <div class="update">
        <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
            <input id="search" type="text" name="search" placeholder="Search" onkeyup="searchHint(<?=$field?>,<?=$order?>,this)">
        </form>
    </div>   
</header>
